...
public class RNCX5WebViewClient extends WebViewClient {
  ...
  public void onPageFinished(WebView webView, String url) {
    ...
    if (!mLastLoadFailed) {
      RNCX5WebView reactWebView = (RNCX5WebView) webView;
  ...
  public boolean shouldOverrideUrlLoading(WebView view, String url) {
    final RNCX5WebView rncWebView = (RNCX5WebView) view;
    ...
    if (!isJsDebugging && rncWebView.mCatalystInstance != null) {
      ...
      ((RNCX5WebView) view).dispatchEvent(
        view,
